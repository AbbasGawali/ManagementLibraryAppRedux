  ...
  return (
    <div className="px-8 py-4">
      ...
      {filteredBooks.length >= 1 ? (
        <div className="flex gap-6 flex-wrap py-2">
          {filteredBooks.map((item) => (
            ...
            >
              ...
              <Link
                to={`/book/${item.id}`}
                className="py-2 mb-4 border-2 text-center text-red-500 font-bold border-red-500 shadow-lg hover:bg-red-500 hover:text-white transition-all"
              >
                Visit Book
              </Link>
            </div>
        ...
        <div className="text-red-500 font-bold w-1/4 mx-auto">
