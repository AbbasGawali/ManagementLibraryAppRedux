  ...
  return (
    <div className="py-4 px-8">
      ...
      <h2 className="font-bold text-xl py-4">
        {" "}
        Popular <span className="text-red-500">Books</span>
      </h2>
      <div className="popularBooks flex gap-6 flex-wrap py-2">
        {popularBooks?.map((item) => (
          ...
          >
            ...
            <Link
              to={`/book/${item.id}`}
              className="py-2 text-center mb-4 border-2 text-red-500 font-bold border-red-500 shadow-lg hover:bg-red-500 hover:text-white transition-all"
            >
              Visit Book
            </Link>
          </div>
